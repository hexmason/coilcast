...
def to_get_song_response(media_file: MediaFile):
    return {
        "song": {
            "@id": media_file.id,
            "@parent": media_file.album_id,
            "@isDir": False,
            ...
            "@created": media_file.created_at,
            "@albumId": media_file.album_id,
            "@artistId": media_file.artist_id,
            "@type": "music",
            "@isVideo": False,
        }
    }
